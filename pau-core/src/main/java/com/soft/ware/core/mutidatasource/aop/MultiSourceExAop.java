package com.soft.ware.core.mutidatasource.aop;

import com.soft.ware.core.mutidatasource.DataSourceContextHolder;
import com.soft.ware.core.mutidatasource.annotion.DataSource;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.soft.ware.core.mutidatasource.annotion.DataSource)")
    private void cut() {
