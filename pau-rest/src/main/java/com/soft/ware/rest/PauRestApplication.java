...
import com.soft.ware.rest.modular.auth.filter.ConstomerUserHandlerMethodArgumentResolver;
...
public class PauRestApplication extends WebMvcConfigurerAdapter {
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        ...
        argumentResolvers.add(new ConstomerUserHandlerMethodArgumentResolver());
    }
