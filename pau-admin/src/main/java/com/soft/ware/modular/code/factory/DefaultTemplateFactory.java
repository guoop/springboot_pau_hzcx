package com.soft.ware.modular.code.factory;

import com.soft.ware.StartUpController;
import com.soft.ware.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("paulo");
        genQo.setProjectPackage(StartUpController.class.getPackage().getName());
