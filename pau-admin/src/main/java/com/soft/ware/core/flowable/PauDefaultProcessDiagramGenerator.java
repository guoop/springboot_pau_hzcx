...
package com.soft.ware.core.flowable;
 ...
 * 修复线的文字显示
 */
public class PauDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public PauDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public PauDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
