...
import com.soft.ware.generator.engine.SimpleTemplateEngine;
import com.soft.ware.generator.engine.base.PauTemplateEngine;
import com.soft.ware.generator.engine.config.ContextConfig;
import com.soft.ware.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void dopauGeneration() {
        PauTemplateEngine pauTemplateEngine = new SimpleTemplateEngine();
        pauTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        pauTemplateEngine.setSqlConfig(sqlConfig);
        pauTemplateEngine.setTableInfo(tableInfo);
        pauTemplateEngine.start();
    }
}
